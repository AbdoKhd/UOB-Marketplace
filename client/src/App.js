  ...
  return (
    <AuthProvider>
      <Routes>
        ...
        <Route path="/listings/:category" element={<ListingsPage />} />
        <Route path="/listings/:category/search/:searchQuery" element={<ListingsPage />} />
        ...
        <Route path="/otherListings/:pageTitle/:userId" element={ <OtherListingsPage/>} />
      </Routes>
    </AuthProvider>
  )
}
